...
class PurposeTransectionPage extends StatefulWidget {
  const PurposeTransectionPage({super.key});

  @override
  State<PurposeTransectionPage> createState() => _PurposeTransectionPageState();
}

class _PurposeTransectionPageState extends State<PurposeTransectionPage> {
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Get.toNamed(Routes.transferCodePage);
                        },
                        child: Padding(
